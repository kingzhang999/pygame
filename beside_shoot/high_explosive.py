...
class High_Explosive(Sprite):
	...
	def __init__(self,ai_game):
		...
		self.rect = pygame.Rect(0,0,self.settings.high_explosive_width,
			self.settings.high_explosive_height)
	...
	def update(self):
		"""向右移动子弹"""
		#更新表示子弹位置的小数值
		self.x += self.settings.high_explosive_speed
		#更新子弹的位置
		self.rect.x = self.x
